...
extract_orders_task = BashOperator(
    ...
    bash_command='python /Users/cho2jiwoo/airflow/dags/p/extract_orders.py',
    dag=dag,
)

extract_customers_task = BashOperator(
    task_id='extract_customer_data',
    bash_command='python /Users/cho2jiwoo/airflow/dags/p/extract_customers.py',
    dag=dag,
)

load_orders_task = BashOperator(
    task_id='load_order_data',
    bash_command='python /Users/cho2jiwoo/airflow/dags/p/load_orders.py',
    dag=dag,
)

load_customers_task = BashOperator(
    task_id='load_customer_data',
    bash_command='python /Users/cho2jiwoo/airflow/dags/p/load_customers.py',
    dag=dag,
)
...
revenue_model_task = PostgresOperator(
    ...
    sql='/Users/cho2jiwoo/airflow/dags/sql/order_revenue_model.sql',
    dag=dag,
)
